...
},{"../page/about":6,"../page/common":7,"../page/home":8,"./ns":3}],5:[function(require,module,exports){
'use strict';
    ...
    value: function initialize() {
      ...
      $.ajax({
        ...
        eventArr.forEach(function (event) {
          ...
          if (isPast) {} else {
            displayEventArr.push(_extends({}, event, {
...
},{"../module/ns":3,"../module/wba-latest-events":5}],9:[function(require,module,exports){
'use strict';
